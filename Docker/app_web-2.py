...
def performDetect(imagePath="./askedRecognition.jpg", thresh= 0.25, configPath = "./darknet/cfg/yolov3-tiny-obj.cfg", weightPath = "./darknet/yolov3-tiny-obj_1000.weights", metaPath= "./darknet/cfg/obj.data", showImage= False, makeImageOnly = False, initOnly= False):
    """
